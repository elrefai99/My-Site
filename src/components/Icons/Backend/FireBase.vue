...
<template>
    <svg width="1em" height="1em" viewBox="0 0 32 32">
        <path fill="#ffc24a" d="m5.8 24.6l.17-.237l8.02-15.214l.017-.161l-3.535-6.64a.656.656 0 0 0-1.227.207Z"></path>
        <path fill="#ffa712" d="m5.9 24.42l.128-.25l7.937-15.056l-3.526-6.666a.6.6 0 0 0-1.133.206Z"></path>
        <path fill="#f4bd62" d="m16.584 14.01l2.632-2.7l-2.633-5.021a.678.678 0 0 0-1.195 0l-1.407 2.682V9.2Z"></path>
...
<script>
export default {
    name: 'VscodeIconsFileTypeFirebase'
}
</script>